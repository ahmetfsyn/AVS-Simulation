...
namespace Repositories.EFCore
{
    ...
    public sealed class UserRepository : RepositoryBase<User>, IUserRepository
    {
        ...
        // public IQueryable<User> GetAllUsers(bool trackChanges) => FindAll(trackChanges).OrderBy(user => user.Id);
        // public User GetUserById(int id, bool trackChanges) => FindByCondition(user => user.Id == id, trackChanges).SingleOrDefault();
